                ...
                foreach(var foundContext in modContext.Where(context => Settings.TagList("Graphics").Contains(context.ModKey)))
                {
                        ...
                        || Compare.NotEqual(foundContext.Record.Icons,originalObject.Record.Icons))
                    {
                        ...
                        if (Change)
                        {
                            ...
                            if (foundContext.Record.InventoryArt != null && Compare.NotEqual(foundContext.Record.InventoryArt,originalObject.Record.InventoryArt))
                ...
                foreach(var foundContext in modContext.Where(context => Settings.TagList("Text").Contains(context.ModKey)))
                {
                        ...
                        || Compare.NotEqual(foundContext.Record.BookText,originalObject.Record.BookText))
                    {
                        ...
                        if (Change)
                        {
                            ...
                            if (foundContext.Record.BookText != null && Compare.NotEqual(foundContext.Record.BookText,originalObject.Record.BookText))
                                overrideObject.BookText?.Set(foundContext.Record.BookText.TargetLanguage, foundContext.Record.BookText.String);
                        }
                        break;
                    }
                }
