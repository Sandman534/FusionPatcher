...
namespace Fusion
{
    internal class ARTO
    {
        public static void Patch(IPatcherState<ISkyrimMod, ISkyrimModGetter> state, SettingsUtility Settings)
        {
            ...
            HashSet<ModKey> workingModList = Settings.GetModList(Tags.ObjectBounds);
            HashSet<FormKey> affectedFormKeys = Utility.GetAffectedFormKeys<IArtObjectGetter>(state, workingModList);
            Utility.RecordCountMessage(affectedFormKeys.Count, "Art Object");
            ...
            foreach (var formKey in affectedFormKeys)
            {
                ...
                var allContexts = state.LinkCache.ResolveAllContexts<IArtObject, IArtObjectGetter>(formKey).ToList();
                ...
                // Tracking Tags
                IArtObject? overrideObject = null;
